<?php
$recipient = 'alessio.alfieri@outlook.it'; // Enter the recipient's email address here.
$subject   = 'Una nuova richiesta è stata inviata tramite il sito web.'; // Enter the subject of the email here.
